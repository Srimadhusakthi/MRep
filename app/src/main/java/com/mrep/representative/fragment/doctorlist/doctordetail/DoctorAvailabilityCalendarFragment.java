...
public class DoctorAvailabilityCalendarFragment extends RepresentativeBaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        view = inflater.inflate(R.layout.fragment_reprsentative_appointment_callplanner, container, false);
        onFindView();
        onClickListener();
    ...
    private void onClickListener() {
        mCalenderView.setOnEventClickListener(new WeekView.EventClickListener() {
            ...
            public void onEventClick(WeekViewEvent event, RectF eventRect) {
                BookAppointmentDialog bookAppointmentDialog =new BookAppointmentDialog();
                bookAppointmentDialog.show(activity.getSupportFragmentManager(),getResources().getString(R.string.book_appointment));
            }
        });
    }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        activity.onFragmentInteractions(3, activity.getResources().getString(R.string.book_appointment));
    }
