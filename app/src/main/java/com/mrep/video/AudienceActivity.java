...
public class AudienceActivity extends AppCompatActivity {
    ...
    private void initEngineAndJoin() {
        ...
        mRtcEngine.joinChannel(getResources().getString(R.string.agora_access_token), getResources().getString(R.string.label_channel_name), "Extra Optional Data", Constant.AUDIENCE_UID);
