...
public class BroadcasterActivity extends AppCompatActivity {
    ...
    private void joinChannel() {
        mRtcEngine.joinChannel(getResources().getString(R.string.agora_access_token), getResources().getString(R.string.label_channel_name), "Extra Optional Data", Constant.CAMERA_UID); // if you do not specify the uid, we will generate the uid for you
    }
