...
public class OneToOneVideoChatViewActivity extends AppCompatActivity {
    private static final String TAG = OneToOneVideoChatViewActivity.class.getSimpleName();
    ...
    private void joinChannel() {
        ...
        mRtcEngine.joinChannel(getResources().getString(R.string.agora_access_token), getResources().getString(R.string.label_channel_name), "Extra Optional Data", 0);
    }
    ...
    public void onShareClicked(View view) {
        mSSClient.start(getApplicationContext(), getResources().getString(R.string.agora_app_id), getResources().getString(R.string.agora_access_token),
...
//        }
    ...
    private void setupRemoteView(int uid) {
        ...
        mLocalContainer.addView(ssV, new FrameLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT));
