...
import com.mrep.R;
import com.mrep.video.OneToOneVideoChatViewActivity;

public class DoctorPopupActivity extends AppCompatActivity implements View.OnClickListener {
    private MaterialButton btn_login, btn_submit_otp;
    private AppCompatImageButton btn_cancel_verification;
    private Activity activity;
    private Toolbar toolbar;
    private MaterialCardView otp_verification_layout;
    private NestedScrollView welcome_screen_layout;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.doctor_activity_login_verfication);
        onFindViews();
        onClickListener();
        onSetToolbar();
    }
    ...
    private void onFindViews() {
        activity = DoctorPopupActivity.this;
